...
//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
Player.prototype.getPartyIcons = function() {
    var txt = new Texture (64, settings.screen.height - 21);
    for (var i = 0; i < 4; i++) {
        txt.print("Andy", 45, 0 + (i * 45));
        txt.print("LVL: 4", 0, 0 + (i * 45));
        txt.print("HP : 40/50", 0, 10 + (i * 45));
        txt.print("MP : 5/5", 0, 20 + (i * 45));
        txt.print("EXP: 3423/23344", 0, 30 + (i * 45));
        txt.draw(ASSET.down1, 45, 7 + (i * 45));
