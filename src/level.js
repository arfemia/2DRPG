...
exports.load = function (levelId) {
	...
	var l = 0;
	var layer = getMap(path + 'F' + l);
	while(layer) {
		t.overlayLayers.push(layer);
		layer = getMap(path + 'F' + (++l));
	}
...
//▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
exports.drawOverlay = function() {
	for (var i = 0; i < t.overlayLayers.length; i++) {
		draw(t.overlayLayers[i], 0, 0);
	}
}
